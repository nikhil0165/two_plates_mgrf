...
born_radius1 = 2.8# radius of cation in Angstroms
born_radius2 = 1.5 # radius of anion in Angstroms
rad_sol_d = max(born_radius1,born_radius2)

domain_d = 26.0 # separation between two plates in Angstroms
domain_in_d = 26.0 # separation between two plates of the initial guess
