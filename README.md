...
- Support for arbitrary salt mixtures and surface charge densities
- This branch is the most general version for two plate geometry, works for systems with and without dielectric contrast
