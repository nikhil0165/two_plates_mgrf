...
ncc_cutoff_pb = 1e-5 # some cutoff parameter for non-constant coefficients on LHS of NLBVP of PB
...
cores = 20  # no of parallel processes in which you want to divide fourier inverse calculation
